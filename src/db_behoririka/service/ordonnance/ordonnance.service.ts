...
@Injectable()
export class OrdonnanceService extends ServicesSyncro<MongooseModel<any>,SequelizeModel>{
    constructor(
        ...
        super(syncservicebase,mysqlOrdonnance as any,mongooseOrdonnance as any);
      }
