...
@Injectable()
export class AdherentService extends ServicesSyncro<MongooseModel<any>,SequelizeModel> {
    constructor(
        ...
        super(syncservicebase,mysqlAdherent as any,mongooseAdherent as any)
      }
