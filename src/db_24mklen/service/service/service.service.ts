...
import { Service as ServiceSql } from 'src/db_24mklen/schema/mysql/service.schema'; 
import { Service as ServiceMongo } from 'src/db_24mklen/schema/mongodb/service.schema';
...
export class ServiceService extends ServicesSyncro<MongooseModel<any>,SequelizeModel,Connection>{
    constructor(
        ...
        @InjectModel(ServiceMongo.name,'db_24mklen') private readonly mongooseService: Model<ServiceMongo>,
