...
export class ServicesSyncro<N extends MongooseModel<any>, M extends  SequelizeModel,P extends Connection> {
    ...
    async migrateTableFilleNormalFunction(){
        console.log(this.mongooseconnection)
    ...
    async updatefromGlobalToSql(){
        return await this.syncroService.updateGlobalToSQL(this.sequelizeModel as any);
    }
    async migratefromGlobalToSqlWithId(){}
