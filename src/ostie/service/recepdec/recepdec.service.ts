...
@Injectable()
export class RecepdecService extends ServicesSyncro<MongooseModel<any>,SequelizeModel,Connection>{
    constructor(
        ...
        super(syncservicebase,mysqlRecepdec as any,mongooseRecepdec as any,connexion);
      }
